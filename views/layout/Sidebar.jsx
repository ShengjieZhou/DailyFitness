                ...
                <ul>
                  <div className="opacity-100" style={{ transition: 'opacity 250ms ease-in-out' }}>
                    <div id="react-collapsed-panel-:R49bm:" aria-hidden="false" style={{ boxSizing: 'border-box' }}>
                      <ul>
                        <li>
                          <a title="食谱推荐" target="" className="p-2 pr-2 w-full rounded-none lg:rounded-r-2xl text-left hover:bg-gray-5 relative flex items-center justify-between pl-5 text-base font-bold text-primary" href="/">
                            <span>食谱推荐</span>
                        ...
                        <li>
                          <a title="饮食建议" target="" className="p-2 pr-2 w-full rounded-none lg:rounded-r-2xl text-left hover:bg-gray-5 relative flex items-center justify-between pl-5 text-base font-bold text-primary" href="/">
                            <span>饮食建议</span>
                            <span className="pr-1 text-tertiary ">
                              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" className="duration-100 ease-in transition -rotate-90" style={{ minWidth: '20px', minHeight: '20px' }}>
                              <g fill="none" fillRule="evenodd" transform="translate(-446 -398)">
                        ...
                        <li>
                          <a title="健身视频" target="" className="p-2 pr-2 w-full rounded-none lg:rounded-r-2xl text-left hover:bg-gray-5 relative flex items-center justify-between pl-5 text-base font-bold text-primary" href="/">
                            <span>健身视频</span>
                            <span className="pr-1 text-tertiary ">
                              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" className="duration-100 ease-in transition -rotate-90" style={{ minWidth: '20px', minHeight: '20px' }}>
                              <g fill="none" fillRule="evenodd" transform="translate(-446 -398)">
                        ...
                        <li>
                          <a title="日志" target="" className="p-2 pr-2 w-full rounded-none lg:rounded-r-2xl text-left hover:bg-gray-5 relative flex items-center justify-between pl-5 text-base font-bold text-primary" href="/">
                            <span>日志</span>
                            <span className="pr-1 text-tertiary ">
                              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" className="duration-100 ease-in transition -rotate-90" style={{ minWidth: '20px', minHeight: '20px' }}>
                              <g fill="none" fillRule="evenodd" transform="translate(-446 -398)">
