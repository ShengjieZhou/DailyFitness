                ...
                <ul>
                  <div className="opacity-100" style={{ transition: 'opacity 250ms ease-in-out' }}>
                    <div id="react-collapsed-panel-:R49bm:" aria-hidden="false" style={{ boxSizing: 'border-box' }}>
                      <ul>
                        <li>
                          <a title="Recipe recommendation" target="" className="p-2 pr-2 w-full rounded-none lg:rounded-r-2xl text-left hover:bg-gray-5 relative flex items-center justify-between pl-5 text-base font-bold text-primary" href="/recipe">
                        ...
                        <li>
                          <a title="Dietary recommendation" target="" className="p-2 pr-2 w-full rounded-none lg:rounded-r-2xl text-left hover:bg-gray-5 relative flex items-center justify-between pl-5 text-base font-bold text-primary" href="/dietary">
